...
background_image_path = os.path.join(current_dir, "pozadina_start.jpg")
background_image = pygame.image.load(background_image_path)
background_image = pygame.transform.scale(background_image, (screen_width, screen_height))

game_options_background_path = os.path.join(current_dir, "pozadina_options.jpg")
...
game_instructions_background_path = os.path.join(current_dir, "pozadina_upute.jpg")
...
hover_color =  (0, 0, 139) # tamno plava boja kad s mjišem prijeđemo preko gumba
...
# Učitavanje zvukova
pygame.mixer.music.load(os.path.join(current_dir, "background_music.mp3"))  # Zamijenite "background_music.mp3" s datotekom vaše glazbe
hit_sound = pygame.mixer.Sound(os.path.join(current_dir, "hit_sound.mp3"))  # Zamijenite "hit_sound.wav" s datotekom zvuka za udarac

# Postavke za reprodukciju glazbe
pygame.mixer.music.set_volume(0.5)  # Prilagodite glasnoću prema potrebi
pygame.mixer.music.play(-1)  # -1 označava ponavljanje glazbe
                        ...
                        if restart_text_rect.collidepoint(mouse_pos):
                            ...
                            while True:
                                ...
                                if current_screen == "start":
                                    ...
                                    draw_button("Kreni", screen_width // 2 - 100, 200 + (50 + 20), 200, 50, button_color,  hover_color, start_game)
                                    draw_button("Upute", screen_width // 2 - 100, 200 + 2* (50 + 20), 200, 50, button_color,  hover_color, upute)
                                    draw_button("Izađi", screen_width // 2 - 100, 200 + 5 * (50 + 20), 200, 50, button_color,  hover_color, exit_game)
                                elif current_screen == "options":
                                    screen.blit(game_options_background, (0, 0))
                                    draw_button("1v1", screen_width // 4 - 100, 400, 200, 50, button_color,  hover_color, start_1vs1_game)
                                    draw_button("1 vs Bot", 3 * screen_width // 4 - 100, 400, 200, 50, button_color,  hover_color, start_vs_bot_game)
                                    draw_button("Povratak", screen_width // 2 - 100, 500, 200, 50, button_color,  hover_color, return_to_start)
