...
background_image = pygame.image.load(os.path.join(current_dir, "pozadina_start.jpg")).convert_alpha()
background_image = pygame.transform.scale(background_image, (screen_width, screen_height))

game_options_background = pygame.image.load(os.path.join(current_dir, "pozadina_options.jpg")).convert_alpha()
game_options_background = pygame.transform.scale(game_options_background, (screen_width, screen_height))

game_instructions_background = pygame.image.load(os.path.join(current_dir, "pozadina_upute.jpg")).convert_alpha()
...
# kako bi osigurali pravilno zatvaranje mixer-a
pygame.mixer.quit()
pygame.quit()
sys.exit()
